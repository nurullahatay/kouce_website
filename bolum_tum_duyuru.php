<?php
    ...
    $duyurular = $db->query("select * from duyurular where aktif=1 and tur=2 and bitTarih > '{$tarih}' ",PDO::FETCH_ASSOC);
...
<head>
    <meta charset="UTF-8">
    <title>Kocaeli Üniversitesi Bilgisayar Mühendisliği Bolum Duyuruları</title>
...
<div id="content" class="bottom-border-shadow">
  ...
  <div class="panel-heading " style="text-align:center;font-size:19px">Genel Duyuruları</div>
