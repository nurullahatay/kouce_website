<?php
	...
	$duyurular = $db->query("select * from duyurular where aktif=1 and tur=1 and bitTarih > '{$tarih}' ",PDO::FETCH_ASSOC);
...
<head>
	<meta charset="UTF-8">
	<title>Kocaeli Üniversitesi Bilgisayar Mühendisliği Genel Duyurular</title>
