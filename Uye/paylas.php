...
if(!empty($_POST))
{
    ...
    $ekle = $db->prepare("insert into duyurular set baslik = ?,basTarih = ?,bitTarih = ?,icerik = ?,link = ? , aktif = ?,tur = ? , kID = ?");
    $ekle->execute(array($baslik ,$basTarih ,$bitTarih ,$icerik,$link , $aktif, $tur , $kID));    
    if($ekle)
    {
